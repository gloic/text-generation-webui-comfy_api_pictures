...
def output_modifier(string, state):
    ...
    img_tag = generate_webui(cleaned_string, params['selected_workflow'], params['comfyui_url'])
    if img_tag:
        string = img_tag + "\n" + text
...
def ui():
    with gr.Column():
        ...
        generate_btn.click(on_generate_test, inputs=[test_prompt, selected_workflow, comfy_url], outputs=output_image)
